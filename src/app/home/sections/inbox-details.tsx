...
export default function InboxDetails() {
  ...
  return (
    <div className="w-1/4 p-2 flex flex-col gap-8 bg-background">
      ...
      <div>
        <div className={`bg-muted text-foreground w-full p-2`}>Activities</div>
        <div className="p-4">
          ...
          <div className="flex flex-col gap-6 my-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="flex text-muted-foreground items-center gap-2 text-sm my-1">
                  <IoIosSend className="w-4 h-4" /> Send 3rd, Feb
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="flex text-muted-foreground items-center gap-2 text-sm my-1">
                  <LucideMailOpen className="w-4 h-4" /> Opened 5th, Feb
                </p>
              </div>
            </div>
